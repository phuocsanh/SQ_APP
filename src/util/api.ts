...
export class Api {
  ...
  /** form-urlencoded */
  async post<T = ApiResponse>(url: string, body?: AnyObject, params?: unknown): Promise<T> {
  ...
  /** raw-JSON */
  async postRaw<T = ApiResponse>(url: string, body?: AnyObject, params?: unknown): Promise<T> {
  ...
  /** form-urlencoded */
  async put<T = ApiResponse>(url: string, body?: AnyObject, params?: unknown): Promise<T> {
    const data = transformPostData(body);
  ...
  /** raw-JSON */
  async putRaw<T = ApiResponse>(url: string, body?: AnyObject, params?: unknown): Promise<T> {
    const data = JSON.stringify(body);
  ...
  /** form-urlencoded */
  async patch<T = ApiResponse>(url: string, body?: AnyObject, params?: unknown): Promise<T> {
    const data = transformPostData(body);
  ...
  /** raw-JSON */
  async patchRaw<T = ApiResponse>(url: string, body?: AnyObject, params?: unknown): Promise<T> {
    const data = JSON.stringify(body);
